...
from network import ms_cnn, _conv_fusion_block, _fully_connected, _batch_norm
...
#     net, end_points = resnet_v1.resnet_v1_101(img, 81, is_training=False)
#
# print(net)

#
# # # printing OrderedDict object (end_points)
# # for k, v in end_points.items():
# #     print(k, v)
#
# # end_points['resnet_v1_101/conv1'
# print(end_points['resnet_v1_101/conv1'].shape)
# print(end_points['resnet_v1_101/block1/unit_2/bottleneck_v1'].shape)
# print(end_points['resnet_v1_101/block2/unit_3/bottleneck_v1'].shape)
# print(end_points['resnet_v1_101/block3/unit_22/bottleneck_v1'].shape)
# print(end_points['resnet_v1_101/block4/unit_2/bottleneck_v1'].shape)
# print("------")
...
# output = _batch_norm(fc1, 'fc1_bn', is_training=False, activation_fn=tf.nn.sigmoid)
# print("ms_cnn:", output.shape)


def multiscale_resnet101(end_points, num_classes):
    fusion2 = _conv_fusion_block(end_points['resnet_v1_101/conv1'], 256, 'fusion2_', True)
    print(fusion2.shape)
    fusion2 = tf.add(end_points['resnet_v1_101/block1/unit_2/bottleneck_v1'], fusion2)
    print("after fusion2 (add)", fusion2.shape)
    ...
    logit = _batch_norm(logit, 'fc2_bn', is_training=False, activation_fn=None)
